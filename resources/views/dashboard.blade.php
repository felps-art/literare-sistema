    ...
    <div class="col-12">
        <div class="bg-primary text-white rounded-3 p-5">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-4 brand-font mb-3">
                        <i class="fas fa-book-open me-3"></i>Bem-vindo à Literare
                    </h1>
                    <p class="lead mb-4">
                    ...
                    @else
                        <a href="{{ route('resenhas.create') }}" class="btn btn-light btn-lg me-3">
                ...
                <div class="col-lg-4 text-center">
                    <i class="fas fa-books display-1" style="opacity: 0.3;"></i>
                </div>
            </div>
        </div>
    </div>
